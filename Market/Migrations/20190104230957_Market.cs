        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Medidas_Categorias_CategoriaId",
            ...
            migrationBuilder.CreateTable(
                name: "InsumoHasCategorias",
                columns: table => new
                {
                    IdInsumoHasCategoria = table.Column<int>(nullable: false)
                        .Annotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn),
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_InsumoHasCategorias", x => x.IdInsumoHasCategoria);
                    table.ForeignKey(
                        name: "FK_InsumoHasCategorias_Categorias_CategoriaId",
                        column: x => x.CategoriaId,
                        principalTable: "Categorias",
                        principalColumn: "IdCategoria",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_InsumoHasCategorias_Insumos_InsumoId",
                        column: x => x.InsumoId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Produtos_Medidas_TamanhoId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_InsumoHasCategorias_CategoriaId",
                table: "InsumoHasCategorias",
                column: "CategoriaId");

            migrationBuilder.CreateIndex(
                name: "IX_InsumoHasCategorias_InsumoId",
                table: "InsumoHasCategorias",
                column: "InsumoId");

            migrationBuilder.CreateIndex(
                name: "IX_Medidas_CategoriaId",
                table: "Medidas",
                column: "CategoriaId");
